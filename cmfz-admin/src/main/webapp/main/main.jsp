...
<script type="text/javascript">
    function addTab(menuName,menuCode){
        ...
        if(b){
            ...
            $("#tt").tabs("add",{
                title:menuName,
				href : "${pageContext.request.contextPath}/main/"+menuCode+".jsp",
            });
        }
    }
		...
		$.ajax({
			...
			success:function(res){
			    $.each(res,function(index,obj){
                    console.log(obj);
                    var content = "";
                    $.each(obj.childs,function(index1,obj1){
						content += "<p style=\"text-align: center\"><a class=\"easyui-linkbutton\" data-options=\" iconCls:'" +obj1.menuIcon+ "',plain:true \" onclick=\"addTab('"+obj1.menuName+"','"+obj1.menuCode+"')\">" +obj1.menuName+ "</a></p>"
					});
                    $("#aa").accordion("add",{
                        title:obj.menuName,
...
<body class="easyui-layout">   
    <div data-options="region:'north',split:true" style="


    height:60px;background-color:  #5C160C">
