<html xmlns="http://www.w3.org/1999/xhtml" contentType="text/html;charset=UTF-8" language="java">
<% %>
<head>
	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$("#captchaImage").click(function(){//点击更换验证码
			    ...
			    $.ajax({
                   type:"get",
					url:"user/getVcode",
                    success:function () {
                        $("#captchaImage").attr("src","user/getVcode")
                    }
                })
			});
			...
			$("#loginForm").bind("submit",function(){
                 $("#loginForm").prop("action","user/login")
			});
		});
	</script>
</head>
					  ...
					  <tr>
						...
						<tr>
							...
							<td>
								...
								<img id="captchaImage" class="captchaImage" src="/user/getVcode" title="点击更换验证码"/>
							</td>
						</tr>
					<tr>
						<td>
